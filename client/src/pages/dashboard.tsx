...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <div className="fixed top-0 left-0 right-0 z-50 flex justify-between items-center bg-green-600 text-white p-3 pt-4 shadow-lg" style={{paddingTop: 'max(0.6rem, env(safe-area-inset-top, 1rem))'}}>
