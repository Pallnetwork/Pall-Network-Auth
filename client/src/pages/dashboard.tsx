...
const handleSaveInvitation = async () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <div className="flex justify-between items-center bg-green-550 text-white px-4 py-1 shadow-lg" style={{paddingTop: 'max(0.5rem, env(safe-area-inset-top, o.5rem))'}}>
