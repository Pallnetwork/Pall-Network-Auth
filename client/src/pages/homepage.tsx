      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <section className="py-20 bg-muted/30 rounded-3xl">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-5xl mx-auto">
            ...
            <Card className="text-center hover:shadow-lg transition-shadow">
              <CardContent className="pt-6">
                <Smartphone className="w-12 h-12 mx-auto mb-4 text-orange-500" />
                <h3 className="font-semibold mb-2">Android APK/AAB</h3>
                <p className="text-sm text-muted-foreground mb-4">Native Android application</p>
                <Button variant="outline" size="sm" className="w-full" onClick={() => {
                  alert('Android APK/AAB will be available for download once the app is published to Google Play Store.');
                }}>
                  Coming Soon
                </Button>
              </CardContent>
